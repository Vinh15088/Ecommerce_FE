        ...
        <div className="grid grid-cols-10 gap-4 pt-5 border-t-2 border-gray-300">
            <div className="col-start-2 col-span-8 grid grid-cols-4 gap-4 pb-10">
                ...
                <div className="col-span-3 flex flex-col justify-start pr-8">
                    <div className="grid grid-cols-6 border border-gray-300 rounded-t-lg pt-2 mb-2">
                        <button onClick={() => navigate(ROUTES.USER_ORDERS)} className="text-blue-500 font-semibold pb-2 border-b-2 border-blue-500">Tất cả</button>
